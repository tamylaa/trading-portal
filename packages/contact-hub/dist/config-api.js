...
exports.validateConfiguration = exports.updateConfigurationSection = exports.updateConfiguration = exports.subscribeToConfigurationChanges = exports.resetConfiguration = exports.importConfiguration = exports.getConfigurationSection = exports.getConfigurationSchema = exports.getConfiguration = exports.exportConfiguration = exports.default = void 0;
...
const getConfiguration = () => {
  return _config.configManager.getConfiguration();
};
...
const updateConfiguration = updates => {
  _config.configManager.updateConfiguration(updates);
  return _config.configManager.getConfiguration();
};
...
const resetConfiguration = () => {
  _config.configManager.resetToDefaults();
  return _config.configManager.getConfiguration();
};
...
const getConfigurationSection = section => {
  return _config.configManager.getConfigurationSection(section);
};
 ...
 */
exports.getConfigurationSection = getConfigurationSection;
const updateConfigurationSection = (section, updates) => {
  _config.configManager.updateConfigurationSection(section, updates);
  return _config.configManager.getConfigurationSection(section);
};
 ...
 */
exports.updateConfigurationSection = updateConfigurationSection;
const validateConfiguration = updates => {
  const errors = [];
...
const exportConfiguration = () => {
  return _config.configManager.exportConfiguration();
};
...
const importConfiguration = jsonConfig => {
  return _config.configManager.importConfiguration(jsonConfig);
};
...
const subscribeToConfigurationChanges = callback => {
  return _config.configManager.subscribe(callback);
};
 ...
 */
exports.subscribeToConfigurationChanges = subscribeToConfigurationChanges;
  ...
  return {
    ...
    behavior: {
      ...
      properties: {
        ...
        enableContactValidation: {
          type: 'boolean'
        },
        autoSave: {
          type: 'boolean'
        },
        enableDuplicatesCheck: {
          type: 'boolean'
        }
      }
    },
    ...
    events: {
      type: 'object',
      properties: {
        enableContactCreated: {
          type: 'boolean'
        },
        enableContactUpdated: {
          type: 'boolean'
        },
        enableContactDeleted: {
          type: 'boolean'
        },
        enableContactImported: {
          type: 'boolean'
        },
        enableContactExported: {
          type: 'boolean'
        },
        enableSearchChanged: {
          type: 'boolean'
...
var _default = exports.default = configApi;